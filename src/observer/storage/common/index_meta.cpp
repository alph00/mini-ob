...
const static Json::StaticString INDEX_NAME("index_name");//索引名
const static Json::StaticString INDEX_FIELD_NAMES("index_field_names");//多列索引列名合起来
const static Json::StaticString FIELD_NAME("field_name");//索引列名
